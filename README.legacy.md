# Hi, I'm Anh Vu Pham
I’m a Data Scientist based in Montreal, Canada.

- **Resume**: [`AnhVuPham_Resume_2026.pdf`](AnhVuPham_Resume_2026.pdf)
- **Email**: `anhvupham.ma@gmail.com`
- **LinkedIn**: [anh-vu-pham](https://www.linkedin.com/in/anh-vu-pham/){:target="_blank"}
- **GitHub**: [phamou](https://github.com/phamou){:target="_blank"}
- **Tableau**: [Public Tableau](https://public.tableau.com/app/profile/anh.vu.pham/){:target="_blank"}

## Current stack (2026)
- **Data & analytics**: SQL, Python, Snowflake, dbt, PySpark/Snowpark
- **Experimentation & product analytics**: Statsig, PostHog, Amplitude
- **BI & reporting**: Metabase, Sigma Computing, Looker, Tableau
- **Collaboration**: Git, Notebooks, Jira

## Recent experience
- **Data Scientist, Shakepay (Aug 2025 – Present)**: segmentation/metrics frameworks for launches; causal impact modeling; funnel analysis; improved experiment instrumentation at 100K+ user scale.
- **Data Analyst (Product-led Growth & Lifecycle), Autodesk (Nov 2022 – Aug 2025)**: onboarding framework using ML on usage data; reporting & telemetry to enable A/B testing; re-engagement strategy analysis.
